...
const Gallery2 = () => {
  ...
  return (
    <div className='gallery_container mt-20'>
      ...
      {/* Video360° para que los invitados se diviertan con esta experiencia. Es una base con brazo móvil, que gira y genera Videos 360°, Full HD, con efectos agregados y un marco personalizado. 
VIDEOS INCREIBLES que todos querrán compartir en sus redes sociales. 
El servicio Incluye:
 Videos ilimitados en las horas de alquiler. Los videos se suben a la nube, y se comparte un código QR para que los invitados puedan descargar y compartir sus videos en el evento. 
Personal Idóneo operando el equipo. */}
      <div className="w-full flex md:flex-row md:justify-center flex-col md:h-72 gap-10 bg-gradient-to-r from-white via-blue-200 to-white md:mb-5 p-5">
      ...
      <Link to="/contact" className='h-14 bg-lime-500 rounded p-3 cursor-pointer text-white font-bold text-xl hover:scale-95 shadow-lg shadow-black'>¡Reserva Ya!</Link>
