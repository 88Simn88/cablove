  ...
  return (
    <div className='mt-20 w-full  flex flex-col  items-center bg-gradient-to-r from-blue-200 via-white to-blue-200'>
      ...
      <div className='xl:1/2 pt-10 h-fit md:w-3/4 flex flex-col items-center gap-10 '>
        <h1 className='text-center text-4xl font-bold '>Fotocabina</h1>
        ...
        <div className='h-3/4 w-4/5 md:h-60 md:w-full flex flex-col rounded-lg items-center md:flex-row bg-gradient-to-b from-blue-600 to-white md:gap-24 gap-5 shadow-md shadow-black md:rounded-lg'>
          ...
          <div className='h-3/4 w-4/5 md:h-60 md:w-98 flex flex-col items-center md:flex-row bg-gradient-to-b from-blue-600 to-white md:gap-24 shadow-md shadow-black rounded-lg'>
    ...
    <Link to="/contact" className='bg-lime-500 rounded p-4 cursor-pointer text-white font-bold text-xl shadow-lg shadow-black'>Reserva Ya!</Link>
