  ...
  return (
    <motion.div className='slider-container'>
      <motion.div
        ...
        Tunel <span className='text-lime-400'> Led</span> Infinito
      </motion.div>
      ...
      <div className='h-fit m-5'>
        ...
        <motion.div
          ...
          className='md:h-72 w-4/5 flex flex-col md:flex-row md:w-2/3 m-auto mb-5 '>
        ...
        <motion.div
          ...
          className='md:h-72 w-4/5 flex flex-col-reverse md:flex-row md:w-2/3 m-auto mb-5 '>
        ...
        <div className='flex flex-col items-center mt-10'>
          <Link
            to="/contact"
            className='h-14 bg-lime-500 rounded p-3 cursor-pointer text-white font-bold text-xl mb-5 hover:scale-95 shadow-lg shadow-black'
